                                    ...
                                    <form action="{{ route('update-profile') }}" method="POST">
                                        ...
                                        <div class="form-group has-success">
                                            ...
                                            <input name="first_name" type="text" class="form-control"
                                                placeholder="Enter First Name" value="{{ $customer_info->first_name }}">
                                        </div>

                                        <div class="form-group has-success">
                                            <label class="control-label mb-2">Last Name *</label>
                                            <input name="last_name" type="text" class="form-control"
                                                placeholder="Enter Last Name" value="{{ $customer_info->last_name }}">
                                        </div>
                                        ...
                                        <div class="form-group has-success">
                                            ...
                                            <input name="phone" type="text" class="form-control"
                                                placeholder="Enter Phone Number" value="{{ $customer_info->phone }}">
                                        </div>

                                        <div class="form-group has-success">
                                            <label class="control-label mb-2">Zip Code *</label>
                                            <input name="zip_code" type="text" class="form-control"
                                                placeholder="Enter Zip Code" value="{{ $customer_info->zip_code }}">
                                        </div>
