                                ...
                                <div class="col-sm-6">
                                    <div class="shipping-info">
                                        ...
                                        <div class="shipping-chooes">
                                            <div class="sc-item">
                                                <input type="radio" name="shipping_method" id="one"
                                                    value="next_day_delivery">
                                                <label for="one" id="method_one">Next day delivery<span>৳ 150
                                                        BDT</span></label>
                                            </div>
                                            <div class="sc-item">

                                                <input type="radio" name="shipping_method" id="two"
                                                    value="standard_delivery">
                                                <label for="two" id="method_two">Standard delivery<span>৳ 50
                                                        BDT</span></label>
                                            </div>
                                            <div class="sc-item">
                                                <input type="radio" name="shipping_method" id="three"
                                                    value="personal_pickup">
                                                <label for="three" id="method_three">Personal
                                                    Pickup<span>Free</span></label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="cart-total-details">
                                        ...
                                        <ul class="cart-total-card">
                                            ...
                                            <li class="total">Subtotal<span
                                                    id="grand_total">{{ number_format($subTotal, 2, '.', ',') }}</span><span>৳</span>
                                            </li>
                                        </ul>
                                        <button type="submit" class="btn btn-block btn-success">Proceed to
                                            checkout</button>
                                    </div>
                                </div>
                            </form>
