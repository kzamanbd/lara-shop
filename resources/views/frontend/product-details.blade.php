            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    <div class="product-details">
                        ...
                        <div>
                            <h3 class="product-price"><span>৳</span>
                                {{ number_format($product->sale_price, 2, '.', ',') }} <del class="product-old-price">৳
                                    {{ number_format($product->product_price, 2, '.', ',') }}</del></h3>
                            <span
                                class="product-available">{{ $product->quantity > 0 ? 'In Stock ' . $product->quantity : 'Out Of Stock' }}</span>
                        </div>
                        ...
                        <div class="tab-content">
                            ...
                            <div id="reviews" class="tab-pane fade in {{ $errors->any() ? 'active' : '' }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div id="review-form">
                                            <form action="{{ route('review.store') }}" class="review-form"
                                                method="post">
                                                @csrf
                                                <input type="hidden" name="product_id" value="{{ $product->id }}">
                        ...
                        <div class="product">
                            ...
                            <div class="product-body">
                                ...
                                <h4 class="product-price"><span>৳</span>
                                    {{ number_format($relatedProduct->product_price, 2, '.', ',') }} <del
                                        class="product-old-price">৳
                                        {{ number_format(($relatedProduct->product_price * 5) / 100, 2, '.', ',') }}</del>
                                </h4>
                                <div class="product-rating">
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
