            ...
            <div id="top-header">
                <div class="container">
                    ...
                    <ul class="header-links pull-right">
                        ...
                        @if (Auth::check())
                            <li><a href="{{ route('customer') }}" target="_blank"><i class="fa fa-user-o"></i> My
                                    Account</a></li>
                        ...
                        @else
                            <li><a href="{{ route('register') }}"><i class="fa fa-user-o"></i> Register</a>
                            </li>
                            ...
                            <div class="header-ctn">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="cart-dropdown">
                                                    ...
                                                    <div class="product-body">
                                                        ...
                                                        <h4 class="product-price"><span
                                                                ...
                                                                @php
                                                                    ...
                                                                    $totalPrice =
                                                                        $cart->product->sale_price * $totalQty;
                                                                    $subTotal = $subTotal + $price;
                                                                @endphp
                                                            </span>৳{{ number_format($price, 2, '.', ',') }}</h4>
                                                    </div>
                                                    <a href="{{ route('carts.destroy', ['id' => $cart->id]) }}"
                                        ...
                                        <div class="cart-btns">
                                            @if ($count_qty < 1)
                                                <a href="{{ route('carts.index') }}">Cart Empty <i
                                                        class="fa fa-shopping-bag"></i></a>
                                            @else
                                                <a href="{{ route('carts.index') }}">View Cart <i
                                                        class="fa fa-shopping-bag"></i></a>
                                            @endif
            ...
            <div class="container">
                ...
                <div id="responsive-nav">
                    ...
                    <ul class="main-nav nav navbar-nav">
                        ...
                        @foreach ($categories as $category)
                            <li
                                class="{{ Request::is('products/' . $category->slug) == $category->slug ? 'active' : '' }}">
                                <a
                        ...
                        <div class="col-md-12 text-center">
                            ...
                            <span class="copyright">
                                ...
                                <script>
                                    ...
                                    href="https://facebook.com/zaman7i" target="_blank">Zaman</a>
                            </span>
                        </div>
                    </div>
                    <!-- /row -->
