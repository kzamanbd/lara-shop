					...
					<div class="col-md-4 col-xs-6">
						<div class="shop">
							...
							<div class="shop-body">
								...
								<a href="{{ route('category.products',['slug' => $category->slug]) }}" class="cta-btn">Shop now <i class="fa fa-arrow-circle-right"></i></a>
							</div>
						</div>
					</div>
					<!-- /shop -->
								...
								<div class="col-sm-4">
									...
									<div class="product">
										...
										<div class="product-body">
											...
											<h3 class="product-name"><a href="{{ route('/product-details',['slug' => $product->slug]) }}">{{$bastSale->name}}</a></h3>

											<h4 class="product-price"><span>৳</span> {{number_format($bastSale->sale_price, 2,'.', ',')}} <del class="product-old-price">৳ {{number_format($bastSale->product_price, 2,'.', ',')}}</del></h4>
