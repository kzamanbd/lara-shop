					...
					<div class="col-lg-6">
						<div class="row">
							<div class="col-md-12">
								...
								<input type="text" placeholder="Zipcode *" name="zip_code" value="{{old('zip_code')}}">
								@if (!Auth::guard('customer')->check())
									<input type="checkbox" name="create_account" id="create_account"><label for="create_account">Create Account</label>
