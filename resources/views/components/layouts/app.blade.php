            ...
            <div class="tw--container">
                ...
                <footer class="footer">
                    <span class="footer-text">
                        ...
                        <a href="https://draftscripts.com/prime-dash" class="hover:underline">
                            Prime<span class="text-primary">Dash</span> UI
                        </a>
                    ...
                    <ul class="footer-button">
                        ...
                        <li>
                            <a href="https://github.com/kzamanbd/prime-dash" class="hover:underline" target="_blank">
                                Github
                            </a>
                        </li>
                    </ul>
