                        ...
                        <div class="row g-0">
                            <div class="col-sm-5">
                                <div class="background_bg h-100"
                                    data-img-src="{{ asset('storefront/images/popup_img.jpg') }}"></div>
                            </div>
                            <div class="col-sm-7">
                ...
                <div class="container">
                    <nav class="navbar navbar-expand-lg">
                        <a class="navbar-brand" href="index.html">
                            <img class="logo_light" src="{{ asset('storefront/images/logo_light.png') }}"
                                alt="logo" />
                            <img class="logo_dark" src="{{ asset('storefront/images/logo_dark.png') }}"
                                alt="logo" />
                        </a>
                                ...
                                <div class="cart_box dropdown-menu dropdown-menu-right">
                                    <ul class="cart_list">
                                        ...
                                        <li>
                                            <a href="#" class="item_remove"><i class="ion-close"></i></a>
                                            <a href="#"><img
                                                    src="{{ asset('storefront/images/cart_thamb2.jpg') }}"
                                    ...
                                    <div class="cart_footer">
                                        ...
                                        <p class="cart_buttons"><a href="#"
                                                class="btn btn-fill-line rounded-0 view-cart">View Cart</a><a
                                                href="#"
        ...
        <footer class="footer_dark">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="widget">
                                <div class="footer_logo">
                                    <a href="#"><img src="{{ asset('storefront/images/logo_light.png') }}"
                                            alt="logo" /></a>
                                </div>
            ...
            <div class="bottom_footer border-top-tran">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            <p class="mb-md-0 text-center text-md-start">© 2020 All Rights Reserved by Bestwebcreator
                            </p>
                        </div>
                        <div class="col-md-6">
                            <ul class="footer_payment text-center text-lg-end">
                                <li><a href="#"><img src="{{ asset('storefront/images/visa.png') }}"
                                            alt="visa"></a></li>
                                <li><a href="#"><img src="{{ asset('storefront/images/discover.png') }}"
                                            alt="discover"></a>
                                </li>
                                <li><a href="#"><img src="{{ asset('storefront/images/master_card.png') }}"
                                            alt="master_card"></a></li>
                                <li><a href="#"><img src="{{ asset('storefront/images/paypal.png') }}"
                                            alt="paypal"></a></li>
                                <li><a href="#"><img
                                            src="{{ asset('storefront/images/amarican_express.png') }}"
