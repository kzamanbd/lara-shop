                    ...
                    <div class="card-body">
                        <table class="table table-hover table-bordered">
                            ...
                            <tr>
                                ...
                                <td>{{$order_details->upazala->bn_name.', '.$order_details->district->bn_name.', '.$order_details->division->bn_name}}</td>
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            <tbody>
                                @foreach(App\Models\Billing::where('sale_id',$sale_details->id)->get() as $productBill)
                                    <tr>
                                        <td>{{App\Models\Product::where('id',$productBill->product_id)->first()->name}}</td>
