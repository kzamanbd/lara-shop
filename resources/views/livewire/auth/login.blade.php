<div>
    <div class="my-3">
        <p class="mb-2 hidden text-2xl font-semibold md:block">Welcome to the adventure</p>
        <p class="text-xs">Please sign-in to your account and start the adventure</p>
    </div>

    <div class="my-4 flex items-center gap-4">
        <button
            class="flex w-full items-center justify-center rounded-md border border-gray-200 bg-white p-2 text-sm hover:bg-gray-100 lg:w-1/2 dark:border-gray-500 dark:bg-gray-700 dark:hover:bg-gray-800">
        ...
        <button
            ...
            <span class="hidden md:block">Sign in with Apple</span>
        </button>
    </div>

    <div class="flex items-center justify-between">
        <span class="dark:border-dark w-1/2 border-b"></span>
        <span class="mx-4 text-xs text-gray-500 uppercase dark:text-gray-400">or</span>
        <span class="dark:border-dark w-1/2 border-b"></span>
    </div>
    ...
    <form wire:submit="login" class="my-3">
        ...
        <div class="block">
            ...
            <input wire:model="email" id="email" type="email" name="email" class="form-control"
                placeholder="Email Address" autocomplete="email" autocomplete="username" />
            <x-input-error :messages="$errors->get('email')" class="mt-2" />
        </div>

        <div class="my-2">
            <label for="hs-toggle-password-multi-toggle" class="form-label"> Password </label>
            <div class="relative">
                <input wire:model="password" id="hs-toggle-password-multi-toggle" type="password" class="form-control"
                    placeholder="Enter password" value="password" autocomplete="current-password" />
                <button type="button"
                    ...
                    <svg class="size-3.5 shrink-0" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        ...
                        <line class="hs-password-active:hidden" x1="2" x2="22" y1="2"
                            y2="22"></line>
                        <path class="hs-password-active:block hidden" d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z">
                        </path>
                        <circle class="hs-password-active:block hidden" cx="12" cy="12" r="3"></circle>
                    </svg>
                </button>
            </div>
        ...
        <div class="flex items-center justify-between">
            <label class="inline-flex items-center">
                <input wire:model="remember" type="checkbox" name="remember" class="form-check-input" />
                <span class="ms-3 text-sm">Remember me</span>
            </label>

            <a class="text-primary-600 block text-sm hover:underline" href="{{ route('password.request') }}">
                Forgot password?
            </a>
        </div>

        <div class="mt-4">
            <button type="submit" class="btn btn-primary w-full"> Sign in to your account </button>
        </div>
    </form>
