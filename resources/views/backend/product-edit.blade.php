@extends('components.layouts.app', ['title' => 'Products Edit'])
                    ...
                    <div class="card card-info">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('products.update', $product->id) }}" method="POST"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input name="quantity" type="text" class="form-control"
                                                    placeholder="Enter Product Size" value="{{ $product->quantity }}">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    <img src="{{ $product->image_url }}" id="priview" width="100px" alt="image">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="radio" name="status" value="0"
                                        {{ $product->status == 1 ? '' : 'checked' }}>Unpublished
                                </div>
                                <div class="form-group">
